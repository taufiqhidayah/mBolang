        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="col-15 text-left border-primary">
              <h3 class="font-weight-light text-primary">Tenda Bertipe 7</h3>
            </div>
            <div class="mb-4">
              <div class="slide-one-item home-slider owl-carousel">
                <div><img src="tenda/tenda7.png" alt="Image" class="img-fluid"></div>
                <div><img src="tenda/tenda7.png" alt="Image" class="img-fluid"></div>
                <div><img src="tenda/tenda7.png" alt="Image" class="img-fluid"></div>
                <div><img src="tenda/tenda7.png" alt="Image" class="img-fluid"></div>
              </div>
            ...
            <p>Tenda ini sangat ringan, dengan kekuatan maksimal yang siap untuk kegiatan <i><b>adventure</b></i> yang dapat memuat 7 orang sekaligus.</p>
            <p>Tenda ini....</p>
            <p>Tenda adalah .....</p>
            <p>Tenda adalah ....</p>
          ...
          <div class="col-md-3 ml-auto">
            <h3 class="font-weight-light text-black">Rp. 40.000</h3>
            ...
            <div class="row">
              ...
              <div class="col-8">
                <b><i>Joseph Kirawan</i></b>
                <span class="icon icon-room">Dinoyo, Malang</span>
              </div>
            </div><br><br>
            <div class="row">
